    ...
    return (
        <div>
            ...
            <div className='mt-[100px] flex flex-wrap gap-[30px] ml-[162px]'>
                <CourseOpenCard
                    id="01"
                    job="Introduction to Graphic Design"
                />
                <CourseOpenCard
                    id="02"
...
export default CourseOpenGraphic
