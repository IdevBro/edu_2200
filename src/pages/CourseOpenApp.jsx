    ...
    return (
        <div>
            ...
            <div className='mt-[100px] flex flex-wrap gap-[30px] ml-[162px]'>
                <CourseOpenCard
                    id="01"
                    job="Introduction to Mobile App"
                />
                <CourseOpenCard
                    id="02"
